...
#
var = tk.StringVar()
column1 = tk.Entry(wind, show=None, font=("Lucida Fax", 14))
column1.pack()
column1.place(x=75, y=150)
txt = tk.Text(width=50, height=1, font=("Calibri", 14))
txt.pack()
...
button3 = tk.Button(text='另存为图片(S)', width=12, height=1, command=b3)
button3.pack()
button3.place(x=500, y=250)
button1 = tk.Button(wind, text='确认输入(E)', width=12, height=1, command=insert_point)
button1.pack()
button1.place(x=500, y=150)
button2 = tk.Button(text='选择图片(S)', width=12, height=1, command=b2)
button2.pack()
button2.place(x=500, y=100)
button4 = tk.Button(text='退出(O)', width=12, height=1, command=b4)
button4.pack()
button4.place(y=250, x=300)
button5 = tk.Button(text='关于(A)', command=about, height=1, width=12)
button5.pack()
